...
# pos_path = "../data/dataset/CarData/TrainingImages/pos"
# neg_path = "../data/dataset/CarData/TrainingImages/neg"
...
os.system("python ../object-detector/test-classifier.py -i {} -d {} -v".format(test_im_path,2))
